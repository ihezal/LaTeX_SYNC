\section{Grammaire}
    ...
    \begin{itemize}
        ...
        En particulier, lorsque l’on veut dire que l’on préfère une chose à une autre, 

        \begin{tcolorbox}
            -- {夏}{なつ}より{冬}{ふゆ}のほうが{好}{す}きです。
    ...
    \begin{itemize}
        \item \textbf{Contraste :} On peut traduire en français la particule けど par « mais » ou « bien que » :
        
        \begin{tcolorbox}
            -- 高いけど、買いたいです。すみませんけど、\ruby{手伝}{てつだ}ってくれませんか。

            -- C’est cher, mais j’aimerais l’acheter. Excusez-moi, mais pourriez-vous m'aider ?
        \end{tcolorbox}

        \item \textbf{Adoucir un refus :} C’est le fameux « j’aimerais bien, mais\dots » français.
        
        \begin{tcolorbox}
            -- 行きたいんですけど\dots

            -- J’aimerais bien y aller, mais\dots
        \end{tcolorbox}
    \end{itemize}
    ...
    \subsection{Autres points de grammaire}

        \subsubsection{\~{}とき}

        Signifiant littéralement « temps » ou « moment », le suffixe \~{}とき peut s’attacher aux verbes, adjectifs ou noms pour définir le contexte temporel de l’action principale de votre phrase (« quand », « au moment de »).

        \begin{tcolorbox}
            -- 眠いとき、コーヒーを飲みます。学生のとき、東京に住んでいました。

            -- ねむいとき、コーヒーを　のみます。がくせいのとき、とうきょうに　すんでいました。

            -- Quand j'ai sommeil, je bois du café. Quand j'étais étudiant, j'habitais à Tokyo.
        \end{tcolorbox}

        On peut utiliser ce suffixe avec les verbes à la forme accomplie ou non. Il est important de comprendre la nuance entre 行った\~{}とき (l’action d’aller est déjà accomplie) et 行く\~{}とき (l’action d’aller n’est pas encore accomplie).

        \begin{tcolorbox}
            -- 日本へ行ったとき、カメラを買いました。日本に行くとき、パスポートを準備しました。

            -- Quand je suis allé au Japon, j'ai acheté un appareil photo. Quand je suis allé au Japon, j’ai préparé mon passeport.
        \end{tcolorbox}
