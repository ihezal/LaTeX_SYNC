\section{Conjugaison}
    ...
    La forme neutre ou forme du dictionnaire (\ruby{辞書形}{じしょけい}) est la forme à partir de laquelle nous répartirons puis conjuguerons les verbes. Cette forme s'emploie à l’affirmatif neutre non accompli.

    \begin{enumerate}
        \item \textbf{五段動詞 :} Les verbes godan (\ruby{五段動詞}{}) se terminent par un des neuf kana en う suivants : 
        \begin{itemize}
            \item \ruby{買}{か}う
            \item \ruby{聞}{き}く
            \item \ruby{泳}{およ}ぐ
        ...
        \item \textbf{一段動詞 :} Les verbes ichidan (\ruby{一段動詞}{}) se terminent par [-i]る ou [-e]る. On ne peut pas a priori déterminer si un verbe à la forme en [-i]る ou [-e]る est du groupe 五段 ou 一段.
        \begin{itemize}
            \item \ruby{着}{き}る
            \item \ruby{食}{た}べる
        \end{itemize}
    ...
    La forme inaccomplie (\ruby{未然形}{みぜんけい}) est communément surnommé la forme en \~{}あ. Voyons comment créer cette forme pour les différents groupes :
    ...
    La forme conjonctive (\ruby{連用形}{れんようけい}), communément appelée forme en \~{}い, est utile notamment pour exprimer la formule polie en japonais.
    ...
    La forme hypothétique (\ruby{仮定形}{かていけい}) se forme de la façon suivante :

    \begin{enumerate}
        \item \textbf{五段動詞 :} On remplace le kana en [-u] par le kana en [-e].
        \begin{itemize}
            \item \ruby{使}{つか}う $\rightarrow$ \ruby{使}{つか}え\~
            \item \ruby{歩}{ある}く $\rightarrow$ \ruby{歩}{ある}け\~
            \item \ruby{泳}{およ}ぐ $\rightarrow$ \ruby{泳}{およ}げ\~
            \item \ruby{消}{け}す $\rightarrow$ \ruby{消}{け}せ\~
            \item \ruby{持}{も}つ $\rightarrow$ \ruby{持}{も}て\~
            \item \ruby{死}{し}ぬ $\rightarrow$ \ruby{死}{し}ね\~   
            \item \ruby{呼}{よ}ぶ $\rightarrow$ \ruby{呼}{よ}べ\~
            \item \ruby{休}{やす}む $\rightarrow$ \ruby{休}{やす}め\~
            \item \ruby{取}{と}る $\rightarrow$ \ruby{取}{と}れ\~
        \end{itemize}
        \item \textbf{一段動詞 :} On remblace la syllabe る par れ.
        \begin{itemize}
            \item \ruby{起}{お}きる $\rightarrow$ \ruby{起}{お}きれ\~
            \item \ruby{寝}{ね}る $\rightarrow$ \ruby{寝}{ね}れ\~
        \end{itemize}
        \item \textbf{Verbes irréguliers :}
            \begin{itemize}
                \item する　>　すれ\~{} 
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item 売る　>　うった
        \end{itemize}
        \item \textbf{Verbes 一段 :} On enlève la terminaison る finale, et on ajoute la syllabe た.
        \begin{itemize}
            \item 見る　>　見た
            \item 出る　>　出た
        \end{itemize}
