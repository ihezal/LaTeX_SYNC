\section{Vocabulaire}
    ...
    \begin{tblr}[theme=general, long]{colspec = Q[l]Q[l], title={\ruby{紹介}{しょうかい}する}}
        \ruby{初}{はじ}めまして & enchantée \\
        私は　\dots　です & je suis \dots \\
        \dots　から\ruby{来}{き}ました & je viens de \dots \\
        \dots\ruby{人}{じん}です & je suis \ \\
        \dots　に\ruby{住}{す}んでいます & j'habite à ~ \\
        \dots　を\ruby{勉強}{べんきょう}しています & j'étudie ~ \\
        \ruby{趣味}{しゅみ}は　\dots　です & mon loisir, hobby est ~ \\
        どうぞよろしくお\ruby{願}{ねが}いします & enchantée, ravie de faire votre connaissance \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general]{colspec = {Q[l,2] Q[l,4] Q[l,6]}}
        ...
        どうも & merci \\
        (\~を) お\ruby{願}{ねが}いします & s’il vous plaît (pas de réponse attendue) \\
        (\~を) ください & s’il vous plaît (réponse attendue) \\
        \ruby{良}{よ}かった & je suis si heureux, c’était trop bien \\
        んです、んだ & c’est parce que\dots, en fait\dots (contraction de のです) \\
    \end{tblr}


    \subsection{Noms par par thématique}

        \subsubsection{Les pays}

    \begin{tblr}[theme=general, long]{colspec={Q[l]Q[l]}, title={Noms de pays}}
        日本語 & Signification \\

        \ruby{国}{くに} & pays \\
        \ruby{出身}{しゅっしん} & origine, lieu de naissance \\
        \ruby{日本}{にほん} & Japon \\
        \ruby{中国}{ちゅうごく} & Chine \\
        \ruby{韓国}{かんこく} & Corée du Sud \\
        \ruby{北朝鮮}{きたちょうせん} & Corée du Nord \\
        \ruby{台湾}{たいわん} & Taïwan \\
        タイ & Thaïlande \\
        ベトナム & Vietnam \\
        フランス & France \\
    ...
    \begin{longtblr}[theme=general, long]{colspec={Q[l]Q[l]}, title={Noms de personnes}}
        日本語 & Personne \\
        ...
        \ruby{友達}{ともだち} & amie \\
        \ruby{先生}{せんせい} & professeure, enseignante \\
        \ruby{恋人}{こいびと} & être aimé, amoureuse \\
    \end{longtblr}
    ...
    \begin{longtblr}{%
        ...
        \ruby{都道府県}{とどうふけん} & départements, préfectures (correspond aux quatre kanjis des quatre types de départements) \\
        \ruby{市}{し} & ville (ayant un statut administratif) \\
        \ruby{市役所}{しやくしょ} & mairie \\
        \ruby{区}{く} & arrondissement, district \\
        \ruby{区役所}{くやくしょ} & mairie d'arrondissement \\ 
        \ruby{街}{まち}、\ruby{町}{まち} & quartier, ville (moyenne ou petite) \\
        \ruby{丁目}{ちょうめ} & secteur, sous-quartier \\
        \ruby{村}{むら} & village \\
    ...
    \begin{tblr}[theme=general, long]{colspec={Q[l]Q[l]}}
        日本語 & Signification \\

        \ruby{服}{ふく} & vêtement, habits \\
        \ruby{洋服}{ようふく} & vêtements de style occidental \\
        \ruby{着物}{きもの} & kimono \\
        \ruby{浴衣}{ゆかた} & yukata \\
        シャツ & chemise \\
        Tシャツ & T-shirt \\
        ...
        スカート & jupe \\
        ドレス & robe \\
        \ruby{下着}{したぎ} & sous-vêtements \\
        \ruby{靴}{くつ} & chaussures \\
        \ruby{靴下}{くつした} & chaussettes \\
        スニーカー & baskets, chaussures de sport \\
        \ruby{帽子}{ぼうし} & chapeau, casquette \\
        \ruby{手袋}{てぶくろ} & gants \\
        スカーフ & écharpe \\
        ネクタイ & cravate \\
        ベルト & ceinture \\
        めがね & lunettes \\
        \ruby{水着}{みずぎ} & maillot de bain \\
        パジャマ & pyjama \\
        \ruby{鞄}{かばん} & sac, cartable \\
        \ruby{傘}{かさ} & parapluie \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general, long]{colspec={Q[l]Q[l]}}
        ...
        \ruby{家}{いえ} & maison (bâtiment) \\
        \ruby{家}{うち} & maison (foyer) \\
        \ruby{家具}{かぐ} & mobilier, meubles \\
        \ruby{机}{つくえ} & bureau, table de travail \\
        \ruby{椅子}{いす} & chaise \\
        テーブル & table \\
        ベッド & lit \\
        \ruby{布団}{ふとん} & futon, literie \\
        ソファ & canapé \\
        \ruby{棚}{たな} & étagère, meuble de rangement \\
        \ruby{本棚}{ほんだな} & bibliothèque, étagère à livres \\
        \ruby{箪笥}{たんす} & commode, armoire à tiroirs \\
        \ruby{鏡}{かがみ} & miroir \\
        \ruby{電気}{でんき} & lumière, électricité \\
        \ruby{電灯}{でんとう} & lampe, éclairage électrique \\
        \ruby{時計}{とけい} & horloge \\
        \ruby{冷蔵庫}{れいぞうこ} & réfrigérateur \\
        \ruby{電子}{でんし}レンジ & four à micro-ondes \\
        \ruby{洗濯機}{せんたくき} & machine à laver \\
        \ruby{掃除機}{そうじき} & aspirateur \\
        テレビ & télévision \\
        エアコン & climatisation, chauffage \\
        \ruby{扇風機}{せんぷうき} & ventilateur \\
        ドア & porte \\
        \ruby{鍵}{かぎ} & clé, serrure \\
        \ruby{窓}{まど} & fenêtre \\
        カーテン & rideau \\
        トイレ & toilettes \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general, long]{colspec={Q[l]Q[l]}}
        ...
        \ruby{電話}{でんわ} & téléphone \\
        スマホ & téléphone portable \\
        パソコン & ordinateur (personal computer) \\
        カメラ & appareil photo \\
        ラジオ & radio \\
        \ruby{財布}{さいふ} & portefeuille, porte-monnaie \\
        \ruby{本}{ほん} & livre \\
        \ruby{新聞}{しんぶん} & journal \\
        \ruby{雑誌}{ざっし} & magazine, revue \\
        \ruby{写真}{しゃしん} & photo, photographie \\
        \ruby{箱}{はこ} & boîte, caisse \\
        \ruby{紙}{かみ} & papier \\
        \ruby{鉛筆}{えんぴつ} & crayon à papier \\
        ペン & stylo \\
        \ruby{消}{け}しゴム & gomme \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general, long]{colspec={Q[l]Q[l]}}
        ...
        \ruby{食}{た}べ\ruby{物}{もの} & nourriture, aliment \\
        \ruby{飲}{の}み\ruby{物}{もの} & boisson \\
        \ruby{料理}{りょうり} & plat, cuisine \\
        ご\ruby{飯}{はん} & riz (cuit), repas \\
        \ruby{朝}{あさ}ご\ruby{飯}{はん} & petit déjeuner \\
        \ruby{昼}{ひる}ご\ruby{飯}{はん} & déjeuner \\
        \ruby{晩}{ばん}ご\ruby{飯}{はん} & dîner \\
        \ruby{米}{こめ} & riz (cru) \\
        パン & pain \\
        \ruby{肉}{にく} & viande \\
        \ruby{牛肉}{ぎゅうにく} & bœuf \\
        \ruby{豚肉}{ぶたにく} & porc \\
        \ruby{鶏肉}{とりにく} & poulet, viande de poulet \\
        \ruby{魚}{さかな} & poisson \\
        \ruby{卵}{たまご} & œuf \\
        \ruby{野菜}{やさい} & légumes \\
        \ruby{果物}{くだもの} & fruits \\
        ...
        \ruby{牛乳}{ぎゅうにゅう} & lait \\
        お\ruby{茶}{ちゃ} & thé \\
        \ruby{紅茶}{こうちゃ} & thé noir \\
        \ruby{緑茶}{りょくちゃ} & thé vert (japonais) \\
        コーヒー & café \\
        ジュース & jus, boisson fruitée \\
        お\ruby{酒}{さけ} & alcool, saké \\
        ビール & bière \\
        \ruby{塩}{しお} & sel \\
        \ruby{砂糖}{さとう} & sucre \\
        \ruby{醤油}{しょうゆ} & sauce soja \\
        \ruby{味噌}{みそ} & miso \\
        \ruby{寿司}{すし} & sushi \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general, long]{colspec={Q[l]Q[l]}}
        ...
        \ruby{芸術}{げいじゅつ} & art \\
        \ruby{美術}{びじゅつ} & beaux-arts, art \\
        \ruby{絵}{え} & dessin, peinture, image \\
        \ruby{絵画}{かいが} & peinture, œuvre picturale \\
        \ruby{絵本}{えほん} & livre d'images, album illustré \\
        \ruby{写真}{しゃしん} & photographie \\
        \ruby{彫刻}{ちょうこく} & sculpture \\
        \ruby{作品}{さくひん} & œuvre \\
        \ruby{画家}{がか} & peintre \\
        \ruby{芸術家}{げいじゅつか} & artiste \\
        \ruby{音楽}{おんがく} & musique \\
        \ruby{歌}{うた} & chanson, chant \\
        \ruby{歌手}{かしゅ} & chanteur, chanteuse \\
        \ruby{楽器}{がっき} & instrument de musique \\
        \ruby{動画}{どうが} & vidéo, animation \\
        \ruby{映画}{えいが} & film, cinéma \\
        \ruby{映画館}{えいがかん} & cinéma (salle) \\
        \ruby{劇}{げき} & pièce de théâtre, spectacle \\
        \ruby{劇場}{げきじょう} & théâtre, salle de spectacle \\
        \ruby{演劇}{えんげき} & théâtre (art dramatique) \\
        \ruby{俳優}{はいゆう} & acteur, actrice \\
        \ruby{小説}{しょうせつ} & roman \\
        \ruby{文学}{ぶんがく} & littérature \\
        \ruby{作家}{さっか} & écrivain \\
        \ruby{詩}{し} & poésie, poème \\
        \ruby{漫画}{まんが} & manga, bande dessinée \\
        \ruby{美術館}{びじゅつかん} & musée des beaux-arts \\
        \ruby{博物館}{はくぶつかん} & musée \\
        \ruby{展覧会}{てんらんかい} & exposition \\
        \ruby{展示}{てんじ} & exposition, présentation d'œuvres \\
        \ruby{文化}{ぶんか} & culture \\
        \ruby{伝統}{でんとう} & tradition \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general, long]{colspec={Q[l]Q[l]}}
        ...
        \ruby{科学}{かがく} & science \\
        \ruby{理科}{りか} & sciences naturelles \\
        \ruby{生物}{せいぶつ} & biologie, être vivant \\
        \ruby{植物}{しょくぶつ} & plante, végétal \\
        \ruby{動物}{どうぶつ} & animal \\
        \ruby{実験}{じっけん} & expérience, expérimentation \\
        \ruby{研究}{けんきゅう} & recherche, étude \\
        \ruby{研究室}{けんきゅうしつ} & laboratoire, salle de recherche \\
        \ruby{実験室}{じっけんしつ} & laboratoire \\
        \ruby{観察}{かんさつ} & observation \\
        \ruby{調査}{ちょうさ} & enquête, étude, investigation \\
        \ruby{結果}{けっか} & résultat \\
        \ruby{方法}{ほうほう} & méthode, manière \\
        \ruby{理由}{りゆう} & raison \\
        \ruby{資料}{しりょう} & document, donnée, matériel de référence \\
        データ & données \\
        \ruby{道具}{どうぐ} & outil, matériel \\
        \ruby{機械}{きかい} & machine \\
        \ruby{器具}{きぐ} & instrument, équipement \\
        \ruby{予定}{よてい} & prévision, projet, planning \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general]{colspec = {Q[l,2] Q[l,4] Q[l,6]}}
        ...
        \ruby{一度}{いちど} & une fois, une opportunité \\
        \ruby{一番}{いちばん} & le plus; premier, meilleur \\
        \ruby{一部}{いちぶ} & une partie, une portion \\

        
        \ruby{皆}{みな}さん & tout le monde \\
    ...
    \begin{tblr}[theme=general]{colspec = {Q[l,2] Q[l,4] Q[l,6]}}
        ...
        \ruby{大}{おお}きい & grand, gros \\
        \ruby{小}{ちい}さい & petit \\
        \ruby{高}{たか}い & grand (en taille), haut \\
        \ruby{低}{ひく}い & petit (en taille), bas \\
        \ruby{長}{なが}い & long \\
        \ruby{短}{みじか}い & court \\
        \ruby{太}{ふと}い & gros, épais \\
        \ruby{細}{ほそ}い & mince, fin \\
        \ruby{重}{おも}い & lourd \\
        \ruby{軽}{かる}い & léger \\
        \ruby{広}{ひろ}い & large, vaste \\
        \ruby{狭}{せま}い & étroit \\
        \ruby{強}{つよ}い & fort, solide \\
        \ruby{弱}{よわ}い & faible, fragile \\
    ...
    \begin{tblr}[theme=general]{colspec = {Q[l,2] Q[l,4] Q[l,6]}}
        ...
        \ruby{早}{はや}い & tôt, rapide (temps) \\
        \ruby{速}{はや}い & rapide (vitesse) \\
        \ruby{遅}{おそ}い & tard, lent \\
        \ruby{近}{ちか}い & proche, près \\
        \ruby{遠}{とお}い & loin, éloigné, distant \\
        \ruby{新}{あたら}しい & nouveau, récent \\
        \ruby{古}{ふる}い & ancien, vieux \\
        \ruby{若}{わか}い & jeune \\
        \ruby{有}{あ}り\ruby{勝}{が}ち（な） & fréquent, commun, usuel \\
        \ruby{珍}{めずら}しい & rare, inhabituel \\
        \ruby{後}{あと} (な) & après, plus tard, restant \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general]{colspec = {Q[l,2] Q[l,4] Q[l,6]}}
        ...
        \ruby{色々}{いろいろ} (な) & divers, varié \\
        \ruby{同}{おな}じ (な) & même, identique, pareil \\
        みたい & similaire à, ressemblant à \\
    ...
    \begin{tblr}[theme=general]{colspec = {Q[l,2] Q[l,4] Q[l,6]}}
        ...
        \ruby{美味}{おい}しい & délicieux, bon, savoureux \\
        \ruby{不味}{まず}い & mauvais, peu appétissant \\
        
        \ruby{凄}{すご}い & superbe, super, très \\
    \end{tblr}
    ...
    \begin{tblr}[theme=general]{colspec = {Q[l,2] Q[l,4] Q[l,6]}}
        ...
        \ruby{恋}{こい}しい & chéri, manqué \\
        \ruby{危}{あぶ}ない & dangereux \\
\ruby{赤}{あか}い & rouge \\
\ruby{明}{あかる}るい & lumineux / clair \\
\ruby{甘}{あま}い & sucré / doux \\
\ruby{青}{あお}い & bleu \\
\ruby{新}{あたら}しい & nouveau / récent \\
\ruby{暖}{あたた}かい & chaud / doux (température) \\
\ruby{熱}{あつ}い & chaud (objet / boisson) \\
\ruby{厚}{あつ}い & épais \\
\ruby{暑}{あつ}い & chaud (temps) \\
\ruby{便利}{べんり} & pratique / utile \\
\ruby{小}{ちい}さい & petit \\
\ruby{近}{ちか}い & proche / près \\
\ruby{大丈夫}{だいじょうぶ} & aller bien / sans problème \\
\ruby{大好}{だいす}き & beaucoup aimer / adorer \\
\ruby{古}{ふる}い & ancien / vieux \\
\ruby{太}{ふと}い & gros / épais \\
\ruby{元気}{げんき} & en forme / énergique \\
\ruby{速}{はや}い & rapide (vitesse) \\
\ruby{早}{はや}い & tôt / rapide (temps) \\
\ruby{下手}{へた} & mauvais / peu doué \\
\ruby{低}{ひく}い & bas / petit (en taille) \\
\ruby{暇}{ひま} & libre / avoir du temps libre \\
\ruby{広}{ひろ}い & large / vaste \\
\ruby{本当}{ほんとう} & vrai / véritable \\
\ruby{欲}{ほ}しい & vouloir / désirer \\
\ruby{細}{ほそ}い & mince / fin \\
\ruby{色々}{いろいろ} & divers / varié \\
\ruby{忙}{いそが}しい & occupé \\
\ruby{痛}{いた}い & douloureux / avoir mal \\
\ruby{嫌}{いや} & désagréable / déplaisant \\
\ruby{丈夫}{じょうぶ} & solide / robuste \\
\ruby{上手}{じょうず} & doué / habile \\
\ruby{辛}{から}い & épicé \\
\ruby{軽}{かる}い & léger \\
\ruby{可愛}{かわい}い & mignon \\
\ruby{結構}{けっこう} & convenable / suffisant / excellent \\
\ruby{黄色}{きいろ}い & jaune \\
\ruby{嫌}{きら}い & ne pas aimer / détester \\
\ruby{綺麗}{きれい} & joli / beau / propre \\
\ruby{汚}{きたな}い & sale \\
\ruby{暗}{くら}い & sombre / obscur \\
\ruby{黒}{くろ}い & noir \\
\ruby{丸}{まる}い & rond \\
\ruby{真}{ま}っ\ruby{直}{す}ぐ & droit / tout droit \\
\ruby{不味}{まず}い & mauvais / mauvais au goût \\
\ruby{短}{みじか}い & court \\
\ruby{難}{むずか}しい & difficile \\
\ruby{長}{なが}い & long \\
\ruby{賑}{にぎ}やか & animé / vivant \\
\ruby{温}{ぬる}い & tiède \\
\ruby{美味}{おい}しい & délicieux / bon \\
\ruby{重}{おも}い & lourd \\
\ruby{面白}{おもしろ}い & intéressant / amusant \\
\ruby{多}{おお}い & nombreux / beaucoup \\
\ruby{大}{おお}きい & grand / gros \\
\ruby{遅}{おそ}い & tard / lent \\
\ruby{立派}{りっぱ} & magnifique / remarquable \\
\ruby{寒}{さむ}い & froid (temps) \\
\ruby{狭}{せま}い & étroit \\
\ruby{白}{しろ}い & blanc \\
\ruby{静}{しず}か & calme / silencieux \\
\ruby{好}{す}き & aimer / apprécier \\
\ruby{少}{すく}ない & peu nombreux / peu \\
\ruby{涼}{すず}しい & frais / agréable (température) \\
\ruby{多分}{たぶん} & probablement / peut-être \\
\ruby{大変}{たいへん} & difficile / pénible / très \\
\ruby{大切}{たいせつ} & important / précieux \\
\ruby{高}{たか}い & haut / grand / cher \\
\ruby{沢山}{たくさん} & nombreux / beaucoup \\
\ruby{楽}{たの}しい & amusant / agréable \\
\ruby{遠}{とお}い & loin / éloigné \\
\ruby{詰}{つま}らない & ennuyeux / sans intérêt \\
\ruby{冷}{つめ}たい & froid (au toucher) \\
\ruby{強}{つよ}い & fort / puissant \\
\ruby{煩}{うるさ}い & bruyant / agaçant \\
\ruby{薄}{うす}い & mince / fin / faible \\
\ruby{若}{わか}い & jeune \\
\ruby{悪}{わる}い & mauvais / mal \\
\ruby{易}{やさ}しい & facile / simple \\
\ruby{安}{やす}い & bon marché / peu cher \\
\ruby{良}{よ}い（いい） & bon \\
\ruby{有名}{ゆうめい} & célèbre / connu \\
    ...
    \begin{tblr}[theme=general]{colspec = {Q[l,2] Q[l,4] Q[l,6]}}
        ...
        \ruby{大抵}{たいてい} & habituellement, généralement \\
        \ruby{良}{よ}く & souvent \\
        \ruby{時々}{ときどき} & de temps en temps \\
        \ruby{一度}{いちど}も & jamais (いちど + particule d’inclusion も) \\
    ...
    \begin{longtblr}{%
        ...
        \ruby{入}{はい}る & entrer \\
        \ruby{着}{つ}く & arriver, atteindre \\
        \ruby{住}{す}む & habiter \\
        のんびりする & flâner, se la couler douce \\
    \end{longtblr}
    ...
    \begin{longtblr}{%
        ...
        \ruby{踊}{おど}る & danser \\
        \ruby{描}{えが}く & dessiner, peindre, décrire \\
