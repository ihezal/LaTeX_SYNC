...
\tcbset{
  general/.style={
    ...
    boxrule=.2mm,
    colframe=couleurmatiere, colback=gris!10, coltitle=gris, colbacktitle=gris!10
  }
}
...
\setlist[itemize,1]{label=\textcolor{couleurmatiere}{$\star$}}
\setlist[itemize,2]{label=\textcolor{couleurmatiere}{--}}
\setlist[itemize,3]{label=\textcolor{couleurmatiere}{\textbullet}}

\setlist[enumerate,1]{label=\textcolor{couleurmatiere}{\arabic*.}}
\setlist[enumerate,2]{label=\textcolor{couleurmatiere}{\alph*.}}
\setlist[enumerate,3]{label=\textcolor{couleurmatiere}{\roman*.}}
