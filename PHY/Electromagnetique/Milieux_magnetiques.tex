\section{Milieux magnétiques}
    ...
    \subsection{Moment magnétique}
        ...
        \end{align*}
        où $\mu = I \int_{\Sigma} d \mathbf{S}$ est le moment magnétique associé à la spire. Le champ magnétique vaut alors 
        \begin{align*}
            \mathbf{B}(\mathbf{r}) 
            &= \nabla \times \mathbf{A} \\
        ...
        L’énergie d’interaction d’un dipôle rigide avec un champ $\mathbf{B}_0$ est 
        \[ U = - \mu \cdot \mathbf{B}_0 \]
        tandis que le couple s’exerçant sur le dipôle est 
        \[ \Gamma = \mu \times \mathbf{B}_0 \]
