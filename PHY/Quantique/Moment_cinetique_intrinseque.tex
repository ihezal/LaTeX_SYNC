...
\end{comment}
    ...
    \subsection{Addition de moments cinétiques}
        ...
        \[ \hat{R}_{\vec{\alpha}} = e^{- \frac{i}{\hbar} \hat{\vec{J}}_1 \cdot \vec{a}} \cdots e^{- \frac{i}{\hbar} \hat{\vec{J}}_N \cdot \vec{a}} = e^{- \frac{i}{\hbar} \hat{\vec{J}} \cdot \vec{a}} \]
        ...
        \begin{align*}
            ...
            \ket{1,0} &\overset{\Updownarrow}{=} \frac{1}{\sqrt{2}\hbar} S_- \ket{1,1} \\
            &= \frac{\ket{+-} + \ket{-+}}{\sqrt{2}}
        \end{align*}
