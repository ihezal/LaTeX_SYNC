\section{Principes fondamentaux}
    ...
    \subsection{Polarisation d’un photon}

    Cette première partie a pour objectif de nous familiariser avec les postulats de la physique quantique, sous la forme d’un problème déjà abordé dans le cas classique.
    ...
    \subsection{Principes fondamentaux en physique quantique}

        \subsubsection{Espace des états}
